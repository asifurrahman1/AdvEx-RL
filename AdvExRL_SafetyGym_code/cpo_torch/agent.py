...
from AdvExRL_safetygym.network import grad_false
from cpo_torch.models import Policy
from cpo_torch.models import Value
...
class Agent:
    ...
    def load_cpo_model(self, path_file):
        if os.path.isfile(path_file):
            ...
            grad_false(self.value)
            print('CPO Model [load] success.')
